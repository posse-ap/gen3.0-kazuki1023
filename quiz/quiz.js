...
const quizSet = [
  ...
  const quizAnswer = [
    [
      ...
      [
        "question1_answer_incorrect_title",
        "question1_answer_correct_title",
        "question1_answer_incorrect-title"
      ]
    ],
    [
      [
      ...
      [
        "question2_answer_incorrect_title",
        "question2_answer_correct_title",
        "question2_answer_incorrect-title"
      ]
    ],
    [
      [
      ...
      [
        "question3_answer_incorrect_title",
        "question3_answer_correct_title",
        "question3_answer_incorrect-title"
      ]
    ],
    [
      [
      ...
      [
        "question4_answer_incorrect_title",
        "question4_answer_correct_title",
        "question4_answer_incorrect-title"
      ]
    ],
    [
      [
      ...
      [
        "question5_answer_incorrect_title",
        "question5_answer_correct_title",
        "question5_answer_incorrect-title"
      ],
    ],
    [
      [
      ...
      [
        "question6_answer_incorrect_title",
        "question6_answer_correct_title",
        "question6_answer_incorrect-title"
      ],
    ],
  ]
...
for (let i = 0; i < quizSetLength; i++) {
  ...
  //     el.classList.toggle("js_answer1_box");
  //   };
  ...
  //   });
  //   document.getElementById(`js_answer_${i + 1}${p + 1}`).addEventListener("click", () => {
  //     const targetnode = document.querySelector(`${quizAnswer[i + 1][1][p]}`);
