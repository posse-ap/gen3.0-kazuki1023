...
<body>
  ...
  <main>
    <h2>ログイン画面</h2>
    <div>
      <form action="http://localhost:8080/admin/login/login_judge.php" method="post" class="login_form" autocomplete="off">
    ...
    <h2>新規登録</h2>
    <div>
      <form action="http://localhost:8080/admin/login/register.php" method="post" class="register_form" autocomplete="off">
